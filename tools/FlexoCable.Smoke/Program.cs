...
{
    Console.Error.WriteLine("No se encontro ConnectionStrings:FlexoCableDB.");
    return 2;
}

var options = new DbContextOptionsBuilder<FlexoDbContext>()
    .UseNpgsql(connectionString)
    .Options;

await using var db = new FlexoDbContext(options);
