# Ferreteria — Estándares de Codificación C# 2026

> **Documento:** FERRETERIA-DEV-STD-001  
> **Versión:** 1.0  
> **Fecha:** Mayo 2026  
> **Responsable:** Equipo de Desarrollo  
> **Última actualización:** 2026-05-22

**Documentos relacionados:** [GIT, PR y revisión](FERRETERIA_GIT_PR_2026.md) (FERRETERIA-DEV-STD-002) · [Índice de docs](README.md) · Skill Cursor: `.cursor/skills/ferreteria-dev/`
...
10. [Ejemplos Aplicados a Ferreteria](#ejemplos-aplicados-a-ferreteria)
...
### Jerarquía de Adoptabilidad para Ferreteria
...
├─────────────────────────────────────────────────┤
│ 4. Estándares internos Ferreteria (Aplicar)     │ ← Este documento
└─────────────────────────────────────────────────┘
```
...
// ❌ NO PERMITIDO en Ferreteria: K&R style
public class Employee {
    public void CalculateSalary() {
        if (_firstName != null) { }
    }
...
En Ferreteria, el esquema PostgreSQL es la **fuente de verdad**. Los modelos deben reflejar exactamente la BD:
...
En Ferreteria, **SIEMPRE** usar inyección de dependencias:
...
public class EmployeeRepository : IEmployeeRepository
{
    ...
    public EmployeeRepository(FerreteriaDbContext dbContext)
    {
...
builder.Services.AddDbContext<FerreteriaDbContext>(options =>
    options.UseNpgsql(builder.Configuration.GetConnectionString("FerreteriaDB")));
...
Ferreteria debe usar herramientas **automáticas** para enforcing:

**1. .editorconfig** (raíz del proyecto)

```ini
# ✅ Ferreteria — EditorConfig Rules
...
### Pre-commit en Ferreteria

Antes de hacer `git commit`, seguir también [FERRETERIA_GIT_PR_2026.md](FERRETERIA_GIT_PR_2026.md) (protocolo git, formato de mensaje y PR). Verificar código con:
...
El protocolo git, emojis en mensajes de commit, plantillas de PR y checklist de revisión por dominio (DTE, inventario, `Squema.sql`) están en **[FERRETERIA_GIT_PR_2026.md](FERRETERIA_GIT_PR_2026.md)**. Este documento (STD-001) cubre solo calidad de código C#.

---

## 📖 Ejemplos Aplicados a Ferreteria
...
- **Ferreteria Dev Team:** Revisar este estándar cada 6 meses o cuando haya cambios en .NET
