# Ferreteria — Git, Pull Requests y Revisión

> **Documento:** FERRETERIA-DEV-STD-002  
> **Versión:** 1.1  
> **Fecha:** Junio 2026  
> **Complementa:** [FERRETERIA_C_CODING_STANDARDS_2026.md](FERRETERIA_C_CODING_STANDARDS_2026.md)
...
2. [Ciclo diario Ferreteria (add → commit → push)](#ciclo-diario-ferreteria-add--commit--push)
...
| Carpeta | Uso |
|---------|-----|
| `Ferreteria/` | WPF Punto de Venta, docs, herramientas |
| `ferreteria_backend/` | Prisma, seed, Docker PostgreSQL |

Cada carpeta puede ser su propio repositorio Git. Entra a la carpeta correcta antes de `git status`, `commit` o `push`.

---

## Ciclo diario Ferreteria (add → commit → push)

Flujo mínimo cada vez que completes algo y quieras dejarlo guardado en GitHub:

```powershell
# 1. Ir al repo correcto
cd "C:\Users\progr\Documents\Ferreteria Sistema\Ferreteria"
# o: cd "...\ferreteria_backend"
...
git add .
# o: git add docs/FERRETERIA_PLAN_FINALIZACION_APP.md
...
Patrón del historial de Ferreteria:
...
Aplicar [FERRETERIA_C_CODING_STANDARDS_2026.md](FERRETERIA_C_CODING_STANDARDS_2026.md) (nomenclatura, async, EF, StyleCop/Roslynator).
...
Antes de `git commit`, además del mensaje y el protocolo git, verificar el **Pre-Commit Checklist** en [FERRETERIA_C_CODING_STANDARDS_2026.md § Checklist de Calidad](FERRETERIA_C_CODING_STANDARDS_2026.md#checklist-de-calidad):
...
|----|---------|-----------|
| FERRETERIA-DEV-STD-001 | `FERRETERIA_C_CODING_STANDARDS_2026.md` | C#, EF, servicios, herramientas |
| FERRETERIA-DEV-STD-002 | `FERRETERIA_GIT_PR_2026.md` | Git, PR, revisión (este documento) |
