    ...
    IAuditService auditService) : IInventoryService
{
    ...
    private static async Task ResolveOpenAlertsAsync(FlexoDbContext dbContext, Guid productId, CancellationToken cancellationToken)
    {
    ...
    private static async Task RaiseAlertIfNeededAsync(FlexoDbContext dbContext, Product product, CancellationToken cancellationToken)
    {
